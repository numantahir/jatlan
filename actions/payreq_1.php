...
if($_SERVER['REQUEST_METHOD'] == "POST"){
	...
	$apply_type_id			= 1;
	$isActive				= 1;
	$advance_type			= 1; //1=>Advance Salary, 2=>Load Request
	...
	if(!$vResult){
				...
				$objQayaduser->setProperty("activity_detail", "New Advance salary request has been submitted by ".$LoginUserInfo["fullname"]);
