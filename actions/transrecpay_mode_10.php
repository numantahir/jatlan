...
//die();
	...
	$entery_id					= trim($_POST["paid_salary_detail_id"]);
			...
			if($objQayadaccount->actAccountTransaction('I')){
				...
				********************************************************************/
				...
				$objQayadaccount->actAccountTransaction('I');
					...
					$objQayaduser->setProperty("paid_salary_detail_id", trim($objBF->decrypt($entery_id, 1, ENCRYPTION_KEY)));
					$objQayaduser->setProperty("pay_mode", 2);
					$objQayaduser->setProperty("transaction_status", 2);
					$objQayaduser->setProperty("transaction_number", $TransactionNumberGen);
					$objQayaduser->actUserMonthlyPaidSalaryDetail('U');
