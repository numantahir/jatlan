...
<input type="hidden" name="aplic_mode" value="17">
<div class="row">
...
<div id="Third_section_" style="display:none;">
  <hr>
  <div class="row">
    <label class="col-sm-2 label-on-left">Amount Transfer:</label>
    <div class="col-sm-9">
  ...
  <div class="row">
    ...
    <div class="col-sm-9">
      <div class="form-group label-floating<?php echo is_form_error($vResult,'pay_mode');?>">
        <select class="selectpicker" data-live-search="true"  data-style="select-with-transition" name="transfer_head_id" id="transfer_head_id" title="List of Transfer Head's" required tabindex="2">
          <?php
					$objQayadaccount->resetProperty();
					$objQayadaccount->setProperty("isActive", 1);
					$objQayadaccount->setProperty("head_type_id_array", '6,8,10,11,12');
                    $objQayadaccount->setProperty("ORDERBY", 'head_title');
                    $objQayadaccount->lstHead();
                    while($AccountHeadList = $objQayadaccount->dbFetchArray(1)){
                    ?>
