...
<input type="hidden" name="aplic_mode" value="16">
<div class="row">
  <label class="col-sm-2 label-on-left">Select Head:</label>
  <div class="col-sm-9">
    <div class="form-group label-floating">
      <select class="selectpicker" data-style="select-with-transition" name="head_id" id="head_id" title="List of Drawing Accounts Head" data-live-search="true" required tabindex="1">
        <?php
...
<div id="otherfields" style="display:none;">
  ...
  <div class="row">
    ...
    <div class="col-sm-9">
      <div class="form-group label-floating<?php echo is_form_error($vResult,'pay_mode');?>">
        <select class="selectpicker" data-style="select-with-transition" data-size="5" data-live-search="true" name="pay_mode" id="pay_mode" title="List of Payment Mode" required tabindex="2">
  ...
  <div class="row">
    ...
    <div class="col-sm-9">
      <div class="form-group label-floating<?php echo is_form_error($vResult,'pay_mode');?>">
        <select class="selectpicker" data-style="select-with-transition" data-size="5" data-live-search="true" name="transfer_head_id" id="transfer_head_id" title="List of Transfer Head's" required tabindex="2">
          <?php
					$objQayadaccount->resetProperty();
					$objQayadaccount->setProperty("isActive", 1);
