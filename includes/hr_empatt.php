...
.shot-leave, .time-over, .late-in, .half-leave-f, .half-leave-s, .present.late-in .present, .present.early-out .absent {
    background: #7C539F;
    width: 170px;
    height: 170px;
    float: right;
...
.HolidayModifiy{
	width: 95%;float: left;text-align: left;margin-left: 5px;
}*/
/*
