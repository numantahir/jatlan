...
<input type="hidden" name="aplic_mode" value="28">
<div class="row">
...
<div class="row">
  ...
  <div class="col-sm-9">
    <div class="form-group label-floating">
      <select class="selectpicker" data-style="select-with-transition" name="transfer_head_id" title="List of Supplier Head" data-live-search="true" required tabindex="1">
        <?php
                    $objQayadaccount->resetProperty();
                    $objQayadaccount->setProperty("isActive", 1);
  ...
  <hr>
  <div class="row">
    <label class="col-sm-2 label-on-left">Transfer Amount:</label>
    <div class="col-sm-9">
  ...
  <div class="row">
    ...
    <div class="col-sm-9">
      <div class="form-group label-floating<?php echo is_form_error($vResult,'pay_mode');?>">
        <select class="selectpicker" data-style="select-with-transition" name="pay_mode" id="pay_mode"data-size="5" data-live-search="true" title="List of Payment Mode" required tabindex="2">
