...
<input type="hidden" name="aplic_mode" value="1">
<div class="row">
  <label class="col-sm-2 label-on-left">Select Customer Head:</label>
  <div class="col-sm-9">
    <div class="form-group label-floating">
      <select class="selectpicker" data-style="select-with-transition" name="head_id" id="head_id" title="List of Customer Head" data-live-search="true" required tabindex="1">
        <?php
                    ...
                    while($AccountHeadList = $objQayadaccount->dbFetchArray(1)){
						...
						$CustomerDetail = $objSSSjatlan->dbFetchArray(1);
                    ?>
        <option value="<?php echo EncData($AccountHeadList["head_id"], 1, $objBF);?>"> <?php echo $AccountHeadList["head_code"] . ' - ' . $AccountHeadList["head_title"] . ' -> '.$CustomerDetail["customer_address"];?> </option>
        <?php } ?>
      </select>
    </div>
  </div>
...
<div id="otherfields" style="display:none;">
  <hr>
  <div class="row">
    <label class="col-sm-2 label-on-left">Amount Received:</label>
    <div class="col-sm-9">
