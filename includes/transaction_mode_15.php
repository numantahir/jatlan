...
<div class="row">
  <label class="col-sm-2 label-on-left">Mobil Supplier Head:</label>
  <div class="col-sm-9">
    <div class="form-group label-floating">
      <select class="selectpicker" data-style="select-with-transition" name="head_id" id="head_id" title="List of Mobil Oil Supplier Head" data-live-search="true" required tabindex="1">
        <?php
