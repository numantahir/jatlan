        ...
        <div class="card">
          <form id="TypeValidation" class="form-horizontal" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="card-header card-header-text" data-background-color="rose">
              <h4 class="card-title"><?php echo SetFormPageTitle('Customer Information', $mode);?></h4>
            </div>
            <div class="toolbar btn-back text-right"> <a href="<?php echo Route::_('show=customers');?>" class="btn">Back</a> </div>
            ...
            <div class="row">
              <label class="col-sm-2 label-on-left">Customer Category</label>
              <div class="col-sm-9">
                <div class="form-group label-floating">
                  <select class="selectpicker" data-style="select-with-transition" required name="customer_category" title="Select Category" tabindex="2">
                    <?php echo $objSSSjatlan->CustomerType($customer_category);?>
                  </select>
                </div>
              </div>
            </div>
           ...
           <div class="row">
            ...
            <div class="row">
              <label class="col-sm-2 label-on-left">Customer Location</label>
              <div class="col-sm-9">
                <div class="form-group label-floating">
                  <select class="selectpicker form-control" data-style="select-with-transition" required name="location_id" title="Select Location" tabindex="6">
                    <?php echo $objSSSjatlan->CustomerLocation($location_id);?>
                  </select>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-sm-9">
                <div class="form-group label-floating<?php echo is_form_error($vResult,'customer_business_name');?>">
                  <label class="control-label"></label>
                  <input class="form-control" type="text" name="customer_business_name" value="<?php echo $customer_business_name;?>" tabindex="8" />
           ...
           <hr />
            ...
            <div class="row">
              ...
              <div class="col-sm-9">
                <div class="form-group label-floating">
                  <select class="selectpicker" data-style="select-with-transition" name="isActive" title="Status" tabindex="11">
            ...
            <div class="card-footer text-center col-md-12">
              <button type="submit" class="btn btn-rose btn-fill" tabindex="12">Submit</button>
