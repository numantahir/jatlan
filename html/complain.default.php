      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <?php } ?>
            ...
            <?php } else { ?>
            <h3 class="card-title CardWidth">List of Pending Complains</h3>
            <?php if($objCheckLogin->user_type != 5){ ?>
            <div class="toolbar add-btn text-right"><a href="<?php echo Route::_('show=complainform');?>" class="btn btn-primary">Add New</a> </div>
            <?php } ?>
              ...
              <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
				...
				?>
                  <tr>
                    ...
                    <td>
                    <?php if($objCheckLogin->user_type == 5){ ?>
                    <a href="<?php echo Route::_('show=complain&i='.EncData($ListofComplain["complain_id"], 2, $objBF));?>">View</a>
                    <?php } else { ?>
                    <?php if($ListofComplain["complain_status"] != 3){?>
                    <a href="<?php echo Route::_('show=complainform&i='.EncData($ListofComplain["complain_id"], 2, $objBF));?>"><i class="material-icons">edit</i></a>
                    <?php } } ?>
                    </td>
                  </tr>
                  <?php } ?>
