...
<div class="content">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
      <h3 class="card-title CardWidth"><?php echo dateFormate_4($OrderRequest["d_date"]).' <code>['.$OrderRequest["tran_code"].']</code>';?> Management</h3>
       ...
       <div class="modal fade transaction" id="receivedpaymentpopup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
               ...
               <table class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                <tbody>
                  <tr>
                    <td align="center"><a href="<?php echo Route::_('show=outsideexpnsform&apm='.EncData('2', 2, $objBF).'&ori='.EncData('ori-'.$OrderRequest["order_request_id"], 2, $objBF));?>">Diesel Expense</a></td>
                  </tr>
                   <tr>
                    <td align="center"><a href="<?php echo Route::_('show=outsideexpnsform&apm='.EncData('3', 2, $objBF).'&ori='.EncData('ori-'.$OrderRequest["order_request_id"], 2, $objBF));?>">Mobil Oil Expense</a></td>
                  </tr>
                   <tr>
                    <td align="center"><a href="<?php echo Route::_('show=outsideexpnsform&apm='.EncData('4', 2, $objBF).'&ori='.EncData('ori-'.$OrderRequest["order_request_id"], 2, $objBF));?>">Tyre Expense</a></td>
                  </tr>
                </tbody>
              </table>
