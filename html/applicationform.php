...
<div class="modal fade" id="applicationform" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-notice modal-lg">
    ...
    <div>
        ...
        <?php //print_r($_SESSION['JointAplicInfo']);?>
...
$TotalAmountCal = $MonthlyInstalment * 10 + $DownPayment;
?>
  ...
  <div style="margin:30px 0px; text-align:left;"> <b>Total Cost of Unit</b>:<u><?php echo Numberformt($TotalAmountCal);?>/-</u> </div>
  <section class="comptable"> <img src="<?php echo SITE_URL;?>appform/images/tabletop.jpg" />
    <h3 style="margin-bottom:0px; padding-bottom:0px;"><span>DESCRIPTION</span></h3>
    <table class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
      <tr>
        <td class="tdprop">Down Payment on Booking</td>
        <td class="tdprop"><?php echo Numberformt($DownPayment);?></td>
        <td class="tdprop"><?php echo date("jS F, Y", strtotime(date("d-m-Y")));?></td>
      </tr>
      <tr>
        <td class="tdprop">1st Installment</td>
        <td class="tdprop"><?php echo Numberformt($InstalmentDetail);?></td>
        <td class="tdprop">
		<?php 
		$MainDate_1 = date("d-m-Y");
		$firstInstallment = MakeInstalmentDate($MainDate_1, 1, 3); 
		echo MakeInstalmentDate($MainDate_1, 2, 3); ?>
        </td>
      </tr>
      <tr>
        ...
        <td class="tdprop">
        <?php 
		$secInstallment = MakeInstalmentDate($firstInstallment, 1, 3); 
		echo MakeInstalmentDate($firstInstallment, 2, 3); ?>
        </td>
      </tr>
      <tr>
        ...
        <td class="tdprop">
        <?php 
		$thirdInstallment = MakeInstalmentDate($secInstallment, 1, 3); 
		echo MakeInstalmentDate($secInstallment, 2, 3); ?>
        </td>
      </tr>
      <tr>
        ...
        <td class="tdprop">
        <?php 
		$fourthInstallment = MakeInstalmentDate($thirdInstallment, 1, 3); 
		echo MakeInstalmentDate($thirdInstallment, 2, 3); ?>
        </td>
      </tr>
      <tr>
        ...
        <td class="tdprop">
        <?php 
		$fivthInstallment = MakeInstalmentDate($fourthInstallment, 1, 3); 
		echo MakeInstalmentDate($fourthInstallment, 2, 3); ?>
        </td>
      </tr>
      <tr>
        ...
        <td class="tdprop">
        <?php 
		$sixInstallment = MakeInstalmentDate($fivthInstallment, 1, 3); 
		echo MakeInstalmentDate($fivthInstallment, 2, 3); ?>
        </td>
      </tr>
      <tr>
        ...
        <td class="tdprop"><?php echo Numberformt($InstalmentDetail);?></td>
        <td class="tdprop"><?php 
		$sevenInstallment = MakeInstalmentDate($sixInstallment, 1, 3); 
		echo MakeInstalmentDate($sixInstallment, 2, 3); ?></td>
      </tr>
      <tr>
        <td class="tdprop">8th Installment</td>
        <td class="tdprop"><?php echo Numberformt($InstalmentDetail);?></td>
        <td class="tdprop"><?php 
		$eightInstallment = MakeInstalmentDate($sevenInstallment, 1, 3); 
		echo MakeInstalmentDate($sevenInstallment, 2, 3); ?></td>
      </tr>
      <tr>
        <td class="tdprop">9th Installment</td>
        <td class="tdprop"><?php echo Numberformt($InstalmentDetail);?></td>
        <td class="tdprop"><?php 
		$nineInstallment = MakeInstalmentDate($eightInstallment, 1, 3); 
		echo MakeInstalmentDate($eightInstallment, 2, 3); ?></td>
      </tr>
      <tr>
        <td class="tdprop">10th Installment</td>
        <td class="tdprop"><?php echo Numberformt($InstalmentDetail);?></td>
        <td class="tdprop"><?php 
		$nineInstallment = MakeInstalmentDate($nineInstallment, 1, 3); 
		echo MakeInstalmentDate($nineInstallment, 2, 3); ?></td>
      </tr>
    </table>
  </section>
