...
?>
<?php include_once(INC_PATH . 'hr_empatt.php'); ?>
<div class="content">
      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-content">
            <h3 class="card-title CardWidth"><?php echo date("M");?> Attendance of (<?php echo $GetUserDetail["fullname"];?>) </h3>
            <div class="toolbar add-btn text-right"><a href="#" id="print_att">Print</a></div>
            <hr>
...
<div class="cal-arrow">
					...
					<a class="left-arrow" href="<?php echo Route::_('show=eattend&m='.$LastMonth.'&i='.EncData(trim(DecData($_GET["i"], 1, $objBF)), 2, $objBF));?>">
                    <?php } else { ?>
                    <a class="left-arrow" href="javascript:void(0)">
					<?php } ?>
                    <img src="<?php echo SITE_URL;?>assets/img/left-arrow.png" alt="arrow" style="height:35px !important;"></a><span><?php echo MonthList($month).' '.date("Y");?></span>
                    <?php if($NextMonth >= 1 && $NextMonth <= 12){?>
					<a class="right-arrow" href="<?php echo Route::_('show=eattend&m='.$NextMonth.'&i='.EncData(trim(DecData($_GET["i"], 1, $objBF)), 2, $objBF));?>">
                    <?php } else { ?>
                    <a class="right-arrow" href="javascript:void(0)">
					<?php } ?>
                    <img src="<?php echo SITE_URL;?>assets/img/right-arrow.png" alt="arrow" style="height:35px !important;"></a>
						</div>
				</div>
                
<div class="col-md-8 col-xs-12 left-side">
                <table border="0" class="table table-striped table-no-bordered table-hover calendar" id="print_this_att" cellspacing="0" width="100%" style="float: left; margin-right: 10px;">
                  <tr>
                    <th>Sun</th>
                    <th>Mon</th>
                    <th>Tue</th>
