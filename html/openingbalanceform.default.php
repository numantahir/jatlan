      ...
      <div class="col-md-12">
        ...
        <div class="card">
          ...
          <div class="card-content">
            ...
            <div class="toolbar text-right"> <a href="<?php echo Route::_('show=openingbalance');?>" class="btn btn-primary">Back</a> </div>
            <hr>
              ...
              <table data-order="[[ 0, &quot;desc&quot; ]]" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                ...
                <tbody>
                  <?php
					...
					$DebitTranCounter = $objQayadaccount->totalRecords();
					if($DebitTranCounter > 0){
                    $ListOfTransaction = $objQayadaccount->dbFetchArray(1);
						...
						$TransactionAmount = $ListOfTransaction["trans_amount"];
						$TransactionModeSelected = $ListOfTransaction["trans_mode"];
              ...
              <table  data-order="[[ 0, &quot;desc&quot; ]]" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                ...
                <tbody>
                  <?php
					...
					$objQayadaccount->setProperty("trans_type", 8);
                    $objQayadaccount->lstAccountTransaction();
					$CreditTranCounter = $objQayadaccount->totalRecords();
					if($CreditTranCounter > 0){
                    $ListOfTransaction = $objQayadaccount->dbFetchArray(1);
          ...
          <hr /><br />
          <?php 
		  $SumRecourds = $DebitTranCounter + $CreditTranCounter;
		  if($SumRecourds > 0){
		  ?>
            ...
            <div class="col-md-12 Bord-Rt no-border-right">
              ...
              <div class="col-sm-9">
                <div class="form-group label-floating<?php echo is_form_error($vResult,'opening_balance');?>">
                  ...
                  <input class="form-control" type="number" min="0" name="opening_balance" required value="<?php echo $TransactionAmount;?>" tabindex="1" />
            ...
            <div class="row">
              ...
              <div class="col-sm-9">
                <div class="form-group label-floating">
                  <select class="selectpicker" data-style="select-with-transition" name="trans_mode" title="Balance AS" tabindex="2">
                    <option value="1" <?php echo StaticDDSelection(1, $TransactionModeSelected);?> selected>Debit (Pending Payment)</option>
                    <option value="2" <?php echo StaticDDSelection(2, $TransactionModeSelected);?>>Credit (Advance from Client Side)</option>
                  </select>
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-sm-9">
                <div class="form-group label-floating<?php echo is_form_error($vResult,'wrong_reason');?>">
                  <label class="control-label"></label>
                  <input class="form-control" type="text" name="wrong_reason" required tabindex="3" />
                  <small><?php echo $vResult["wrong_reason"];?></small> </div>
              </div>
            </div>
            <div class="card-footer text-center col-md-12">
              <button type="submit" class="btn btn-rose btn-fill modifiy" tabindex="4">Modify</button>
          ...
          <?php } else { ?>
          <div class="row"><div class="col-sm-12" style="text-align:center; color:#F00; border-bottom:dotted 2px #990000;"><h4>System unable to find your entered Transaction Number As (Opending Balance).</h4></div></div>
          <?php } ?>
        </div>
