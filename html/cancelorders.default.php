...
<div class="container-fluid">
  <div class="row">
    <?php if($_GET["i"]==''){?>
    <div class="col-md-12">
      <h3 class="card-title CardWidth">Cancel Orders</h3>
            ...
            <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
              ...
              <tbody>
                <?php
                    ...
                    ?>
                <tr>
                  <td><a href="<?php echo Route::_('show=cancelorders&i='.EncData($OrderProcess["order_id"], 2, $objBF));?>"><?php echo $OrderProcess["order_no"];?></a></td>
                  ...
                  <td><a href="<?php echo Route::_('show=cancelorders&i='.EncData($OrderProcess["order_id"], 2, $objBF));?>">View</a></td>
                </tr>
                <?php } ?>
              </tbody>
            </table>
        ...
        <table class="table table-striped table-no-bordered table-hover follow-up" cellspacing="0" width="100%" style="width:100%">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php 
					if($OrderDetailLsit["update_date"] != ''){
					echo dateFormate_4($OrderDetailLsit["update_date"]);} else { echo 'Null';}?></td>
