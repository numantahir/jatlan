<?php 
include_once(ACTION_PATH.'login.php');?>
<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8" />
...
<link rel="shortcut icon" href="<?php echo SITE_URL;?>assets_id/img/favicon.png">
        ...
        <div class="row">
          <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
            <form method="post" action="" name="frmlogin" id="frmlogin">
              ...
              <!--<div class="card card-login card-hidden" style="background-color: transparent; box-shadow: none;">-->
              <div class="card card-login card-hidden">
                <p class="category text-center"> <a href="<?php echo SITE_URL;?>"> <span><img src="<?php echo SITE_URL;?>assets_ig/img/wc-logo.png" alt="" height="150"></span> </a> </p>
                <div class="card-content"> <span style="color:#F00">
                  ...
                  <div class="input-group"> <span class="input-group-addon"> <!--<i class="material-icons">phone</i>--> </span>
                    <div class="form-group label-floating<?php echo is_form_error($vResult,'user_mobile');?>">
                      <label class="control-label">Mobile Number</label>
                      <input type="number" name="user_mobile" id="user_mobile" class="form-control" required>
                      <small><?php echo $vResult["user_mobile"];?></small> </div>
                  </div>
                  ...
                  <div class="input-group"> <span class="input-group-addon"></span>
                    <div class="form-group label-floating" style="text-align:right"> <span style="text-align:right"><a href="<?php echo Route::_('show=forgot');?>">Forgot Password</a></span> </div>
                  </div>
                </div>
