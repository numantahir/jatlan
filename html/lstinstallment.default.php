      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-content">
           ...
           <?php } else { ?>
            <h3 class="card-title CardWidth">List of Tenant Installmets</h3>
            <div class="toolbar add-btn text-right"><a href="<?php echo Route::_('show=installmentform');?>" class="btn btn-primary">Make New</a> </div>
            <?php } ?>
            <hr>
              ...
              <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
				...
				?>
                  <tr>
                    ...
                    <td>Rs.<?php echo $ListOfInstalment["installment_amount"];?></td>
                    <td><?php echo InstalmentStatus($ListOfInstalment["installment_status"]);?></td>
                     <td><a href="<?php echo Route::_('show=lstinstallment&i='.EncData($ListOfInstalment["tenant_installment_id"], 2, $objBF).'&t='.EncData($ListOfInstalment["tenant_id"], 2, $objBF));?>">View</a></td>
                  </tr>
                  <?php } ?>
                </tbody>
              </table>
