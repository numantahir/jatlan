<div class="content">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
      <?php if($_GET["i"]==''){?>
      <h3 class="card-title CardWidth">List of Customer's</h3>
      <div class="toolbar add-btn text-right mt-50px"> <a href="<?php echo Route::_('show=customerform');?>" class="btn btn-primary">Add New</a> </div>
      <?php } else { 
	  ...
	  ?>
      <h3 class="card-title CardWidth">Customer Detail :: <span class="text-primary"><?php echo $CustomerInfo["customer_name"];?></span></h3>
          ...
          <div class="card-content">
            ...
            <div class="material-datatables">
              <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
				...
				?>
                  <tr>
                    <td><a href="<?php echo Route::_('show=customers&i='.EncData($CustomerList["customer_id"], 2, $objBF));?>"><?php echo $CustomerList["customer_name"];?></a></td>
                    ...
                    <td><?php echo StatusName($CustomerList["isActive"]);?></td>
                    <td><a href="<?php echo Route::_('show=customerform&i='.EncData($CustomerList["customer_id"], 2, $objBF));?>"><i class="material-icons">edit</i></a></td>
                  </tr>
                  <?php } ?>
                </tbody>
              </table>
            ...
            <div class="table-responsive">
              <table class="table" cellspacing="0" width="100%" style="width:100%">
                <tbody>
                  ...
                  <tr>
                    <td class="text-primary label-type">Category</td>
                    <td class="value"><?php echo $GetCustomerCategory["category_name"];?></td>
                  </tr>
