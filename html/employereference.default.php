      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-content">
            <h4 class="card-title CardWidth"><?php echo $EmployeData["fullname"];?> Reference Detail</h4>
            <div class="toolbar text-right"> <a href="<?php echo Route::_('show=employereferenceform&i='.$_GET["i"]);?>" class="btn btn-primary">Add New</a> </div>
              ...
              <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo $Referencelist["contact_no"];?></td>
                    <td><?php echo $Referencelist["company_name"];?></td>
                    <td><a href="<?php echo Route::_('show=employereferenceform&i='.$_GET["i"].'&ei='.EncData($Referencelist["user_reference_id"], 2, $objBF));?>"><i class="material-icons">edit</i></a></td>
                  </tr>
                  <?php } ?>
                </tbody>
              </table>
