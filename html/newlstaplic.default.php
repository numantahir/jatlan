            ...
            <div class="material-datatables">
              <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                ...
                <tbody>
					...
					$objQayadapplication->setProperty("location_id", $objCheckLogin->location_id);	
					}
					*/
                  ...
                  <tr>
                    ...
                    <td><a href="<?php echo Route::_('show=updoc&i='.EncData($ListofAplic["aplic_id"], 2, $objBF));?>">Upload Document</a></td>
                  </tr>
                  <?php } ?>
                </tbody>
              </table>
