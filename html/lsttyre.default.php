<div class="content">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
      <h3 class="card-title CardWidth">Tyre Supplier Management</h3>
       <div class="toolbar add-btn text-right mt-50px"> <a href="<?php echo Route::_('show=tyreform');?>" class="btn btn-primary">Add New</a> </div>
        <div class="card">
            ...
            <div class="material-datatables">
              <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                ...
                <tbody>
					...
					$objSSSjatlan->setProperty("option_type", 3);
                  ...
                  <tr>
                    ...
                    <td><a href="<?php echo Route::_('show=tyreform&i='.EncData($SupplierList["vehicle_exp_id"], 2, $objBF));?>"><i class="material-icons">edit</i></a></td>
                  </tr>
                  <?php } ?>
                </tbody>
              </table>
