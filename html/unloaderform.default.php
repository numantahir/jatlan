        ...
        <div class="card">
          <form id="TypeValidation" class="form-horizontal" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="card-header card-header-text" data-background-color="rose">
              <h4 class="card-title"><?php echo SetFormPageTitle('Unloader Information', $mode);?></h4>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-sm-9">
                <div class="form-group label-floating<?php echo is_form_error($vResult,'customer_address');?>">
                  <label class="control-label"></label>
                  <input class="form-control" type="text" name="customer_address" value="<?php echo $customer_address;?>" tabindex="6" />
              ...
              <div class="col-sm-9">
                <div class="form-group label-floating">
                  <select class="selectpicker" data-style="select-with-transition" name="trans_mode" title="Balance AS" tabindex="10">
                    ...
                    <option value="2" <?php echo StaticDDSelection(2, $isActive);?>>Credit (Advance from Unloader Side)</option>
                  </select>
                </div>
              </div>
            </div>
