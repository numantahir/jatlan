...
<div class="container-fluid">
  <div class="row">
    <?php if($_GET["i"]==''){?>
    <div class="col-md-12">
      <h3 class="card-title CardWidth">Complete Orders</h3>
            ...
            <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
              ...
              <tbody>
                <?php
                    ...
                    ?>
                <tr>
                  <td><a href="<?php echo Route::_('show=dorders&i='.EncData($OrderProcess["order_id"], 2, $objBF));?>"><?php echo $OrderProcess["order_no"];?></a></td>
                  ...
                  <td><a href="<?php echo Route::_('show=dorders&i='.EncData($OrderProcess["order_id"], 2, $objBF));?>">View</a></td>
                </tr>
                <?php } ?>
              </tbody>
            </table>
    ...
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header card-header-text" data-background-color="rose">
          <h4 class="card-title"><?php echo 'Order Delivery Detail';?></h4>
        </div>
        <br />
        <br />
        <table class="table table-striped table-no-bordered table-hover follow-up" cellspacing="0" width="100%" style="width:100%">
          ...
          <tbody>
            <tr>
              <td><?php echo $OrderProcess["d_invoice_no"];?></td>
              <td><?php echo $OrderProcess["d_cof_number"];?></td>
              <td><?php echo $OrderProcess["d_loading_advice_no"];?></td>
              <td><?php echo dateFormate_4($OrderProcess["deliver_date"]);?></td>
            </tr>
          </tbody>
        </table>
