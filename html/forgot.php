<?php include_once(ACTION_PATH.'forgot.php');?>
<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8" />
                ...
                <div class="card-content"> <span style="color:#F00">
                  ...
                  <div class="input-group"> <span class="input-group-addon"> <!--<i class="material-icons">phone</i>--> </span>
                    <div class="form-group label-floating<?php echo is_form_error($vResult,'user_mobile');?>">
                      ...
                      <input type="number" name="user_mobile" id="user_mobile" class="form-control" value="<?php echo $user_mobile;?>" required>
                      <small>Please entery your register mobile number.</small> <small><?php echo $vResult["user_mobile"];?></small> </div>
                  </div>
