      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-content">
           ...
           <div class="toolbar btn-back text-right"> <a href="<?php echo Route::_('show=fwdpayreqproc');?>" class="btn">Back</a> </div>
		   <?php } else { ?>
            ...
            <div class="material-datatables">
              ...
              <table class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                <thead>
                  <tr>
                    ...
                    <th>Apply Date</th>
                    <th align="center">Department Status</th>
                    <th>Approved By</th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <td><?php echo $GetRequestedUserName; ?></td>
                    ...
                    <td><?php echo $PaymentRequest["requested_amount"];?></td>
                     ...
                     <td align="center"><code><strong><?php echo PaymentRequestStatus($PaymentRequest["request_fwd_dep_status"]);?></strong></code></td>
                     <td><?php $objQayaduser->resetProperty(); echo $objQayaduser->GetUserFullName($PaymentRequest["request_fwd_dep_to"]);?></td>
              ...
              <table class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                <tbody>
                  <tr>
                  	<td align="center"><a href="<?php echo Route::_('show=transrecpay&apm='.EncData('12', 2, $objBF).'&i='.EncData(trim(DecData($_GET["i"], 1, $objBF)), 2, $objBF).'&poc='.EncData('auto', 2, $objBF).'&rb='.EncData($LoginUserInfo["user_id"], 2, $objBF));?>" class="payreq_approved btn btn-rose btn-fill">Process Now</a>&nbsp;&nbsp; | &nbsp;&nbsp; <a href="<?php echo Route::_('show=fwdpayreqproc&s='.EncData('ati_1', 2, $objBF).'&rq='.EncData('2', 2, $objBF).'&i='.EncData(trim(DecData($_GET["i"], 1, $objBF)), 2, $objBF).'&rb='.EncData($LoginUserInfo["user_id"], 2, $objBF));?>" class="payreq_reject btn btn-fill">Reject</a></td>
                  </tr>
                </tbody>
              </table>
              ...
              <table class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                <tbody>
                  <tr>
                  	<td align="center"><a href="<?php echo Route::_('show=fwdpayreqproc&s='.EncData('ati_2', 2, $objBF).'&rq='.EncData('1', 2, $objBF).'&i='.EncData(trim(DecData($_GET["i"], 1, $objBF)), 2, $objBF).'&rd='.EncData(date("Ymd"), 2, $objBF).'&rb='.EncData($LoginUserInfo["user_id"], 2, $objBF));?>" class="payreq_approved btn btn-rose btn-fill">Approved</a>&nbsp;&nbsp; | &nbsp;&nbsp; <a href="<?php echo Route::_('show=fwdpayreqproc&s='.EncData('ati_2', 2, $objBF).'&rq='.EncData('2', 2, $objBF).'&i='.EncData(trim(DecData($_GET["i"], 1, $objBF)), 2, $objBF).'&rb='.EncData($LoginUserInfo["user_id"], 2, $objBF));?>" class="payreq_reject btn btn-fill">Reject</a></td>
                  </tr>
                </tbody>
              </table>
              <?php } ?>
              ...
              <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                ...
                <tbody>
					<?php
					$objQayadItemGet = new Qayaduser;
					$objQayadGetByName = new Qayaduser;
					$objQayaduser->resetProperty();
                    $objQayaduser->setProperty("isActive_not", 3);
					$objQayaduser->setProperty("ORDERBY", "payment_request_id DESC");
					$objQayaduser->setProperty("request_fwd_finance_to", $LoginUserInfo["user_id"]);
					$objQayaduser->setProperty("request_fwd_finance_status_array", '2, 4');
                    $objQayaduser->lstPaymentRequestsList();
                    while($PaymentRequest = $objQayaduser->dbFetchArray(1)){
						if($PaymentRequest["apply_type_id"] == 4){
                  ...
                  <td><?php echo $objQayadItemGet->GetUserFullName($PaymentRequest["user_id"]); ?></td>
                    ...
                    <td><?php echo $PaymentRequest["requested_amount"];?></td>
                     <td><?php echo dateFormate_4($PaymentRequest["apply_date"]);?></td>
                  <td><?php echo PaymentRequestStatus($PaymentRequest["request_fwd_dep_status"]); ?></td>
                   <td><?php if($PaymentRequest["request_fwd_dep_status"] != 6){
				   $objQayadGetByName->resetProperty(); echo $objQayadGetByName->GetUserFullName($PaymentRequest["request_fwd_dep_to"]);
				   } else {
					echo '';
				   }
				   ?></td>
                    ...
                    <td><a href="<?php echo Route::_('show=fwdpayreqproc&rq='.EncData('View', 2, $objBF).'&i='.EncData($PaymentRequest["payment_request_id"], 2, $objBF));?>">View</a></td>
                  </tr>
                  <?php } ?>
                </tbody>
              </table>
