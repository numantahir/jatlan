...
class Crypt_Blowfish
{
    ...
    function &factory($mode = 'ecb', $key = null, $iv = null, $engine = CRYPT_BLOWFISH_AUTO)
    {
        ...
        switch ($engine) {
            case CRYPT_BLOWFISH_PHP:
                ...
                include_once CLASS_PATH.'Crypt/Blowfish/' . $mode . '.php';
                $crypt = new $class(null);
                break;

            case CRYPT_BLOWFISH_MCRYPT:
                include_once CLASS_PATH.'Crypt/Blowfish/MCrypt.php';
     ...
     * @access public
     */
    function encrypt($plainText, $KeyPass)
    {
	   return base64_encode($this->_crypt->encrypt($plainText, $KeyPass));
     ...
     * @access public
     */
    function decrypt($cipherText, $KeyPass)
    {
        return $this->_crypt->decrypt(base64_decode($cipherText, $KeyPass));
    }
